...
(setf (op_t-name ferry-board) "Board")
...
(setf (op_t-name ferry-sail) "Sail")
...
(setf (op_t-name ferry-debark) "Debark")
...
(setf (op_t-name hanoi-move-disk) "Move-Disk")
...
(setf (op_t-name monkey-go-to) "Goto")
...
(setf (op_t-name monkey-climb) "Climb")
...
(setf (op_t-name monkey-push-box) "Push-Box")
...
(setf (op_t-name monkey-get-knife) "Get-Knife")
...
(setf (op_t-name monkey-grab-bananas) "Grab-Bananas")
...
(setf (op_t-name monkey-pick-up-glass) "Pick-up-Glass")
...
(setf (op_t-name monkey-get-water) "Get-Water")
